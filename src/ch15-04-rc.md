...
<Listing number="15-17" file-name="src/main.rs" caption="Ucuncu listenin sahipligini paylasmaya calisan iki `Box<T>`li listeye izin verilmedigini gostermek">
...
<Listing number="15-18" file-name="src/main.rs" caption="`Rc<T>` kullanan `Liste` tanimi">
